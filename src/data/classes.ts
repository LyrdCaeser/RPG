...
export const classDefinitions: CharacterClassDefinition[] = [
  {
    classId: "warrior",
    name: "Chiến binh",
    description: "Đấu sĩ tuyến đầu với phòng thủ vững và sát thương cận chiến ổn định.",
  ...
  },
  {
    classId: "mage",
    name: "Pháp sư",
    description: "Người dùng phép gây sát thương cao với khả năng bùng nổ tầm xa.",
  ...
  },
  {
    classId: "ranger",
    name: "Kiếm sĩ",
    description: "Chiến binh linh hoạt với sát thương cân bằng và tỉ lệ chí mạng tốt.",
  ...
  },
  {
    classId: "priest",
    name: "Linh mục",
    description: "Người hỗ trợ dùng phép, có khả năng hồi phục và tăng trưởng phép bền bỉ.",
  ...
  },
  {
    classId: "assassin",
    name: "Sát thủ",
    description: "Sát thương cận chiến tốc độ cao với tỉ lệ chí mạng lớn.",
